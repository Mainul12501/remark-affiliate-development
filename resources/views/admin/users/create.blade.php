...
@push('styles')
    ...
    <link rel="stylesheet" href="{{asset('backend/select2/select2-bootstrap-5-theme.min.css')}}"/>
                                ...
                                <div class="col-lg-10">
                                    <select required id="account_type" name="account_type" class="form-select @error('account_type') is-invalid @enderror account_type select_account_type" data-placeholder="Select one">
                                       <option value="">Select One</option>
                                        <option value="frontend" {{old('account_type') == 'frontend' ? 'selected': ''}}>Frontend</option>
                                        <option value="backend" {{old('account_type') == 'backend' ? 'selected': ''}}>Backend</option>
                                    </select>
                                    @error('account_type')
