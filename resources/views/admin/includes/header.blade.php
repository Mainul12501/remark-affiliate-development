            ...
            <div class="header-element headerProfile-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    @if(!empty(Auth::user()->profile_image) && file_exists(public_path(Auth::user()->profile_image)))
                        <img src="{{ asset(Auth::user()->profile_image) }}" alt="user" class="rounded-circle" width="37" height="37">
                    @else
                        <img src="{{ asset('backend/default_img/3.png') }}" alt="user" class="rounded-circle" width="37" height="37">
                    @endif
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                    <li>
                        <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                            <div class="my-auto">
                                <h6 class="mb-0 lh-1 text-fixed-white"> {{ Auth::user()->email ?? '' }}</h6>
                    ...
                    <li><a class="dropdown-item d-flex" href="{{url('/admin/my-profile')}}"><i class="fa fa-user-tie fs-18 me-2 op-7"></i>Profile</a></li>
                    <li><a class="dropdown-item d-flex" href="{{url('/admin/password-change')}}"><i class="fas fa-unlock-keyhole fs-18 me-2 op-7"></i>Change Password</a></li>
                    <div class="dropdown-divider"></div>
                    <li>
                        <a class="dropdown-item d-flex" href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out fs-18 me-2 op-7"></i> LOGOUT</a>
